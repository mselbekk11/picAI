    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 p-6'>
      ...
      <Card>
        <div>
          <div>
            <CardHeader>
              <CardTitle className='text-default font-semibold'>✅ Choose Good Pictures</CardTitle>
              <CardDescription className='text-sm mt-2 text-gray-400 pb-4'>
          ...
          <div className=''>
            <CardHeader>
              <CardTitle className='text-default font-semibold'>❌ Examples of Bad Pictures</CardTitle>
              <CardDescription className='text-sm mt-2 text-gray-400 pb-4'>
          ...
          <div className=''>
            <CardHeader>
              <CardTitle className='text-default font-semibold'>✅ Train your Model</CardTitle>
          ...
          <div className=''>
            <CardHeader>
              <CardTitle className='text-default font-semibold'>✅ Generate Images</CardTitle>
              <CardDescription className='text-sm mt-2 text-gray-400'>
