      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16'>
        {[...Array(6)].map((_, index) => (
          <div key={index} className='text-white space-y-6 text-center relative p-6'>
            <div className='bg-lp-light-background/60 size-20 blur-2xl absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2'></div>
            <FaGraduationCap className='size-8 z-50 mx-auto' />
            <h1 className='text-2xl font-bold leading-7'>Free forever</h1>
            <p className='text-lp-subtle text-center text-sm leading-6'>
