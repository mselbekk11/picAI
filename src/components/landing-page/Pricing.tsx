  ...
  return (
    <div id='pricing' className='space-y-[120px] px-6 mt-[200px] mb-24'>
      <div className='space-y-6'>
        ...
        <p className='text-light-grey text-center text-xl  font-normal leading-8 max-w-3xl mx-auto'>
        ...
        {plans.map((plan, index) => (
          <Card
            ...
            <CardContent className='m-8 p-0 text-[#050316]'>
              ...
              <Badge className='text-sm font-medium leading-5 mb-8 bg-lp-light-background'>
                {plan.badge}
              </Badge>
