      ...
      <div className='flex flex-col justify-center '>
        <div className='space-y-[18px] max-w-2xl mx-auto'>
          <div className='px-4 py-1.5 gap-2 bg-[#022f21] rounded-full w-fit mx-auto'>
            <div className='text-lp-primary text-sm font-semibold flex items-center gap-2'>
          ...
          <div className='max-w-96 mx-auto text-center font-medium leading-7 tracking-[0.04px] text-lp-subtle'>
