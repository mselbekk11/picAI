...
import multipleCard from '@/assets/images/multiple-cards.png';
  ...
  return (
    <div className='space-y-[96px] p-6 mt-[200px]'>
      <div className='space-y-6 mx-auto'>
        ...
        <p className='text-lp-subtle text-lg md:text-2xl leading-[34.54px] tracking-[0.2px] text-center max-w-2xl mx-auto'>
        ...
        <div className='p-10 md:p-20 bg-card-background rounded-3xl'>
          <div className='block md:flex gap-5 space-y-12 md:space-y-0'>
            <div className='space-y-5 md:w-1/2'>
              ...
              <p className='text-light-grey text-xl font-light leading-8'>
